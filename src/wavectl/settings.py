    ...
    while True:
        ...
        choice = questionary.select(
            ...
            choices=[
                ...
                questionary.Choice(title=_get_title("term:fontfamily", t("Terminal Font Family"), t("Default")), value="termfontfamily"),
        ...
        if choice == "back":
            ...
            new_val = questionary.text(t("Enter Terminal Font Family (empty to default):"), default=curr).ask()
            if new_val.strip() == "":
                cm.set_config_value("term:fontfamily", None)
